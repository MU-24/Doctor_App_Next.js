        ...
        <form>
          ...
          <div className="p-2 w-full">
            <div>
              <button
                type="submit"
                className="flex w-full items-center text-white bg-gray-900 border-0 py-3 px-6 mb-20 focus:outline-none hover:bg-green-800 rounded text-xl font-bold shadow-lg mx-0 flex-col text-center"
              >
                Send
              </button>
            </div>
